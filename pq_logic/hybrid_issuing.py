...
def build_cert_from_catalyst_request(  # noqa: D417 Missing argument descriptions in the docstring
    ...
    **kwargs,
    ...
    if cert_req_msg["certReq"]["certTemplate"]["publicKey"]["algorithm"]["algorithm"] in COMPOSITE_SIG07_OID_TO_NAME:
...
def _cast_to_composite_sig_private_key(
    ...
    return CompositeSig07PrivateKey(first_key, alt_key)
