...
Invalid COMPOSITE-KEM-05-ML-KEM-768-RSA2048 Key Size    composite-kem-05-ml-kem-768-rsa2048    True
     [Tags]    negative  composite-kem-05  ml-kem  rsa

Valid COMPOSITE-KEM-05-ML-KEM-768-RSA2048 Request    composite-kem-05-ml-kem-768-rsa2048    False
     [Tags]    positive  composite-kem-05  ml-kem  rsa

Invalid COMPOSITE-KEM-05-ML-KEM-768-RSA3072 Key Size    composite-kem-05-ml-kem-768-rsa3072    True
     [Tags]    negative  composite-kem-05  ml-kem  rsa

Valid COMPOSITE-KEM-05-ML-KEM-768-RSA3072 Request    composite-kem-05-ml-kem-768-rsa3072    False
     [Tags]    positive  composite-kem-05  ml-kem  rsa

Invalid COMPOSITE-KEM-05-ML-KEM-768-RSA4096 Key Size    composite-kem-05-ml-kem-768-rsa4096    True
     [Tags]    negative  composite-kem-05  ml-kem  rsa

Valid COMPOSITE-KEM-05-ML-KEM-768-RSA4096 Request    composite-kem-05-ml-kem-768-rsa4096    False
     [Tags]    positive  composite-kem-05  ml-kem  rsa

Invalid COMPOSITE-KEM-05-ML-KEM-768-ECDH-SECP384R1 Key Size    composite-kem-05-ml-kem-768-ecdh-secp384r1    True
     [Tags]    negative  composite-kem-05  ml-kem  ecdh  secp384r1

Valid COMPOSITE-KEM-05-ML-KEM-768-ECDH-SECP384R1 Request    composite-kem-05-ml-kem-768-ecdh-secp384r1    False
     [Tags]    positive  composite-kem-05  ml-kem  ecdh  secp384r1

Invalid COMPOSITE-KEM-05-ML-KEM-768-ECDH-BRAINPOOLP256R1 Key Size    composite-kem-05-ml-kem-768-ecdh-brainpoolP256r1    True
     [Tags]    negative  composite-kem-05  ml-kem  ecdh  brainpoolP256r1

Valid COMPOSITE-KEM-05-ML-KEM-768-ECDH-BRAINPOOLP256R1 Request    composite-kem-05-ml-kem-768-ecdh-brainpoolP256r1    False
     [Tags]    positive  composite-kem-05  ml-kem  ecdh  brainpoolP256r1

Invalid COMPOSITE-KEM-05-ML-KEM-768-X25519 Key Size    composite-kem-05-ml-kem-768-x25519    True
     [Tags]    negative  composite-kem-05  ml-kem  x25519

Valid COMPOSITE-KEM-05-ML-KEM-768-X25519 Request    composite-kem-05-ml-kem-768-x25519    False
     [Tags]    positive  composite-kem-05  ml-kem  x25519

Invalid COMPOSITE-KEM-05-ML-KEM-1024-ECDH-SECP384R1 Key Size    composite-kem-05-ml-kem-1024-ecdh-secp384r1    True
     [Tags]    negative  composite-kem-05  ml-kem  ecdh  secp384r1

Valid COMPOSITE-KEM-05-ML-KEM-1024-ECDH-SECP384R1 Request    composite-kem-05-ml-kem-1024-ecdh-secp384r1    False
     [Tags]    positive  composite-kem-05  ml-kem  ecdh  secp384r1

Invalid COMPOSITE-KEM-05-ML-KEM-1024-ECDH-BRAINPOOLP384R1 Key Size    composite-kem-05-ml-kem-1024-ecdh-brainpoolP384r1    True
     [Tags]    negative  composite-kem-05  ml-kem  ecdh  brainpoolP384r1

Valid COMPOSITE-KEM-05-ML-KEM-1024-ECDH-BRAINPOOLP384R1 Request    composite-kem-05-ml-kem-1024-ecdh-brainpoolP384r1    False
     [Tags]    positive  composite-kem-05  ml-kem  ecdh  brainpoolP384r1

Invalid COMPOSITE-KEM-05-ML-KEM-1024-X448 Key Size    composite-kem-05-ml-kem-1024-x448    True
     [Tags]    negative  composite-kem-05  ml-kem  x448

Valid COMPOSITE-KEM-05-ML-KEM-1024-X448 Request    composite-kem-05-ml-kem-1024-x448    False
     [Tags]    positive  composite-kem-05  ml-kem  x448

Invalid COMPOSITE-KEM-ML-KEM-768-RSA2048 Key Size    composite-kem-ml-kem-768-rsa2048    True
     [Tags]    negative  composite-kem-06  ml-kem  rsa

Valid COMPOSITE-KEM-ML-KEM-768-RSA2048 Request    composite-kem-ml-kem-768-rsa2048    False
     [Tags]    positive  composite-kem-06  ml-kem  rsa
...
Invalid COMPOSITE-KEM-FRODOKEM-976-AES-ECDH-BRAINPOOLP256R1 Key Size    composite-kem-frodokem-976-aes-ecdh-brainpoolP256r1    True
     [Tags]    negative  composite-kem-06  frodokem  ecdh  brainpoolP256r1
...
Valid COMPOSITE-KEM-FRODOKEM-976-AES-ECDH-BRAINPOOLP256R1 Request    composite-kem-frodokem-976-aes-ecdh-brainpoolP256r1    False
     [Tags]    positive  composite-kem-06  frodokem  ecdh  brainpoolP256r1
...
Invalid COMPOSITE-KEM-FRODOKEM-1344-AES-ECDH-BRAINPOOLP384R1 Key Size    composite-kem-frodokem-1344-aes-ecdh-brainpoolP384r1    True
     [Tags]    negative  composite-kem-06  frodokem  ecdh  brainpoolP384r1
