...
COMPOSITE_SIG06_NAME_TO_ORIGINAL_NAME = {
    "composite-sig-06-ml-dsa-44-rsa2048-pss": "id-MLDSA44-RSA2048-PSS-SHA256",
    "composite-sig-06-ml-dsa-44-rsa2048": "id-MLDSA44-RSA2048-PKCS15-SHA256",
    ...
    "composite-sig-06-ml-dsa-65-ecdsa-secp384r1": "id-MLDSA65-ECDSA-P384-SHA512",
    "composite-sig-06-ml-dsa-65-ecdsa-brainpoolP256r1": "id-MLDSA65-ECDSA-brainpoolP256r1-SHA512",
    "composite-sig-06-ml-dsa-65-ed25519": "id-MLDSA65-Ed25519-SHA512",
    "composite-sig-06-ml-dsa-87-ecdsa-secp384r1": "id-MLDSA87-ECDSA-P384-SHA512",
    "composite-sig-06-ml-dsa-87-ecdsa-brainpoolP384r1": "id-MLDSA87-ECDSA-brainpoolP384r1-SHA512",
    "composite-sig-06-ml-dsa-87-ed448": "id-MLDSA87-Ed448-SHAKE256",
    "composite-sig-06-ml-dsa-87-rsa3072-pss": "id-MLDSA87-RSA3072-PSS-SHA512",
    "composite-sig-06-ml-dsa-87-rsa4096-pss": "id-MLDSA87-RSA4096-PSS-SHA512",
    "composite-sig-06-ml-dsa-87-ecdsa-secp521r1": "id-MLDSA87-ECDSA-P521-SHA512",
}

COMPOSITE_SIG06_ORIGINAL_NAME_TO_NAME = {v: k for k, v in COMPOSITE_SIG06_NAME_TO_ORIGINAL_NAME.items()}
...
def _load_composite_sig06_from_public_bytes(algorithm: str, public_key: bytes) -> CompositeSig06PublicKey:
    ...
    return CompositeSig06PublicKey(
        pq_key=pq_key,
        trad_key=trad_key,
    )
...
class TestVectorEntry:
    ...
    _sk_key: Optional[CompositeSig06PrivateKey] = None
    ...
    def secret_key(self) -> CompositeSig06PrivateKey:
        """Return the secret key as a CompositeSig06PrivateKey."""
        _name = COMPOSITE_SIG06_ORIGINAL_NAME_TO_NAME[self.tcId]
        ...
        self._sk_key = _load_composite_sig06_from_private_bytes(algorithm=_name, private_key=sk_bytes)
        return self._sk_key
    ...
    def name(self) -> str:
        ...
        return COMPOSITE_SIG06_ORIGINAL_NAME_TO_NAME[self.tcId]
...
class TestCompositeSig06TestVectors(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.path = "./data/rfc_test_vectors/composite_sig06_testvectors.json"
    ...
    def test_composite_sig06_cert_from_vectors_rsa(self):
        """
        ...
        for vector in self.test_cases:
            ...
            with self.subTest(vector=vector["tcId"]):
                ...
                public_key = _load_composite_sig06_from_public_bytes(test_vec.name, spki["subjectPublicKey"].asOctets())
                if public_key != private_key.public_key():
                    raise ValueError("Public key does not match the private key's public key.")

                alg_id = cert["tbsCertificate"]["signature"]

                _name = COMPOSITE_SIG06_OID_TO_NAME[alg_id["algorithm"]]
                use_pss = False
                if "pss" in _name:
                    use_pss = True
    ...
    def test_composite_sig06_cert_from_vectors_ed(self):
        """
    ...
    def test_composite_sig06_cert_from_vectors_ecdsa(self):
        """
