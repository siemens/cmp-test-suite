...
class TestLoadKeyFromCert(unittest.TestCase):
    ...
    def test_load_kem_key(self):
        ...
        self.assertTrue(loaded_key == load_private_key_from_file("data/keys/private-key-ml-kem-768.pem").public_key())
    ...
    def load_ml_dsa_key(self):
        ...
        loaded_key = load_public_key_from_cert(cert)
        self.assertTrue(loaded_key == load_private_key_from_file("data/keys/private-key-ml-dsa-44.pem").public_key())
    ...
    def test_slh_dsa_key(self):
        ...
        loaded_key = load_public_key_from_cert(cert)
        self.assertTrue(loaded_key == load_private_key_from_file("data/keys/private-key-slh-dsa-sha2-256f.pem").public_key())
