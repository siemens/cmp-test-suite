...
class TestCompositeSig13Cert(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.comp_bad_key = CompositeSig13PrivateKey(trad_key=cls.bad_rsa_key, pq_key=cls.ml_dsa_44_key)
    ...
    def test_cert_comp_sig_pure_rsa(self):
        ...
        comp_key = CompositeSig13PrivateKey(trad_key=rsa_key, pq_key=self.ml_dsa_44_key)
