...
from resources.general_msg_utils import prepare_distribution_point_name
...
class TestPrepareDistributionPointName(unittest.TestCase):
    ...
    def test_prepare_dpn_with_ca_crl_url(self):
        ...
        """
        dist_point_name = prepare_distribution_point_name(ca_crl_url="http://crl.testcompany.com/testcompany.crl")
    ...
    def test_prepare_dpn_with_ca_name(self):
        ...
        """
        dist_point_name = prepare_distribution_point_name(ca_name="CN=testcompany.crl")
    ...
    def test_prepare_dpn_with_ca_name_blank(self):
        ...
        """
        dist_point_name = prepare_distribution_point_name(ca_name="")
        self.assertIsInstance(dist_point_name,rfc9480.DistributionPointName)
