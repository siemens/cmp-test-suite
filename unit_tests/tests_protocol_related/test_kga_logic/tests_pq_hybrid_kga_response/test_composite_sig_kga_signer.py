...
class TestCompositeSigKGASigner(unittest.TestCase):
    ...
    def _generate_kga_extensions(self, key: CompositeSigPrivateKey) -> rfc9480.Extensions:
    ...
    def _generate_kga_cert(self, key: CompositeSigPrivateKey) -> rfc9480.CMPCertificate:
    ...
    def _build_kga_cmp_response(
        self,
        ir: PKIMessageTMP,
        kga_key: CompositeSigPrivateKey,
