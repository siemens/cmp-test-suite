...
class TestFalconKgaSigner(unittest.TestCase):
    ...
    def test_falcon_1024_lwcmp_signer(self):
        """
        GIVEN a Falcon-1024 private key.
        WHEN the KGA response is generated,
        THEN it should return a valid PKIMessageTMP response.
        """
        kga_key = generate_key("falcon-1024")
