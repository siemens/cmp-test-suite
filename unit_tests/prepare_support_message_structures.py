...
def build_genp_pkimessage(info_type_values: List[rfc9480.InfoTypeAndValue]) -> rfc9480.PKIMessage:
    ...
    decoded_pki_message, rest = decoder.decode(der_data, asn1Spec=rfc9480.PKIMessage())
...
def build_genp_get_ca_certs(ca_certs: List[rfc9480.CMPCertificate]) -> rfc9480.PKIMessage:
...
def build_crl_update_retrieval_pkimessage(crl: Optional[rfc5280.CertificateList] = None) -> rfc9480.PKIMessage:
