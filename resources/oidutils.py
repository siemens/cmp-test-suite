...
# ###################
# Composite KEM KMAC OIDS
# ###################

# https://www.ietf.org/archive/id/draft-ounsworth-pq-composite-kem-01.html#name-algorithm-identifiers
# As of Section 4
# is only in some older draft, but still useful, and was not overwritten,
# if as an example FrodoKem wants to be used.

# Assuming kem_composite_mapping and other OID definitions are already set as before


id_MLKEM512_ECDH_P256_KMAC128 = univ.ObjectIdentifier(f"{id_CompKEM}.1")
id_MLKEM512_ECDH_brainpoolP256r1_KMAC128 = univ.ObjectIdentifier(f"{id_CompKEM}.2")
id_MLKEM512_X25519_KMAC128 = univ.ObjectIdentifier(f"{id_CompKEM}.3")
id_MLKEM768_RSA_KMAC256 = univ.ObjectIdentifier(f"{id_CompKEM}.4")
id_MLKEM768_ECDH_P256_KMAC256 = univ.ObjectIdentifier(f"{id_CompKEM}.5")
id_MLKEM768_ECDH_brainpoolP256r1_KMAC256 = univ.ObjectIdentifier(f"{id_CompKEM}.6")
id_MLKEM768_X25519_KMAC256 = univ.ObjectIdentifier(f"{id_CompKEM}.7")
id_MLKEM1024_ECDH_P384_KMAC256 = univ.ObjectIdentifier(f"{id_CompKEM}.8")
id_MLKEM1024_ECDH_brainpoolP384r1_KMAC256 = univ.ObjectIdentifier(f"{id_CompKEM}.9")
id_MLKEM1024_X448_KMAC256 = univ.ObjectIdentifier(f"{id_CompKEM}.10")
id_COMPOSITE_KEM_KMAC128 = univ.ObjectIdentifier(f"{id_CompKEM}.11")
id_COMPOSITE_KEM_KMAC256 = univ.ObjectIdentifier(f"{id_CompKEM}.12")
kem_combiner_mapping = {
    id_MLKEM512_ECDH_P256_KMAC128: "kmac128/256",
    id_MLKEM512_ECDH_brainpoolP256r1_KMAC128: "kmac128/256",
    id_MLKEM512_X25519_KMAC128: "kmac128/256",
    id_MLKEM768_RSA_KMAC256: "kmac256/384",
    id_MLKEM768_ECDH_P256_KMAC256: "kmac256/384",
    id_MLKEM768_ECDH_brainpoolP256r1_KMAC256: "kmac256/384",
    id_MLKEM768_X25519_KMAC256: "kmac256/384",
    id_MLKEM1024_ECDH_P384_KMAC256: "kmac256/512",
    id_MLKEM1024_ECDH_brainpoolP384r1_KMAC256: "kmac256/512",
    id_MLKEM1024_X448_KMAC256: "kmac256/512",
    id_COMPOSITE_KEM_KMAC128: "kmac128/256",
    id_COMPOSITE_KEM_KMAC256: "kmac256/512",
}
kem_oid_to_static_string = {
    id_MLKEM512_ECDH_P256_KMAC128: "id-MLKEM512-ECDH-P256-KMAC128",
    id_MLKEM512_ECDH_brainpoolP256r1_KMAC128: "id-MLKEM512-ECDH-brainpoolP256r1-KMAC128",
    id_MLKEM512_X25519_KMAC128: "id-MLKEM512-X25519-KMAC128",
    id_MLKEM768_RSA_KMAC256: "id-MLKEM768-RSA-KMAC256",
    id_MLKEM768_ECDH_P256_KMAC256: "id-MLKEM768-ECDH-P256-KMAC256",
    id_MLKEM768_ECDH_brainpoolP256r1_KMAC256: "id-MLKEM768-ECDH-brainpoolP256r1-KMAC256",
    id_MLKEM768_X25519_KMAC256: "id-MLKEM768-X25519-KMAC256",
    id_MLKEM1024_ECDH_P384_KMAC256: "id-MLKEM1024-ECDH-P384-KMAC256",
    id_MLKEM1024_ECDH_brainpoolP384r1_KMAC256: "id-MLKEM1024-ECDH-brainpoolP384r1-KMAC256",
    id_MLKEM1024_X448_KMAC256: "id-MLKEM1024-X448-KMAC256",
    id_COMPOSITE_KEM_KMAC128: "id-COMPOSITE-KEM-KMAC128",
    id_COMPOSITE_KEM_KMAC256: "id-COMPOSITE-KEM-KMAC256",
}
KEM_KMAC_COMPOSITE_MAPPING = {
    "ml-kem-512": {
        "ECDH-P256": id_MLKEM512_ECDH_P256_KMAC128,
        "ECDH-brainpoolP256r1": id_MLKEM512_ECDH_brainpoolP256r1_KMAC128,
        "X25519": id_MLKEM512_X25519_KMAC128,
    },
    "ml-kem-768": {
        "RSA": id_MLKEM768_RSA_KMAC256,
        "ECDH-P256": id_MLKEM768_ECDH_P256_KMAC256,
        "ECDH-brainpoolP256r1": id_MLKEM768_ECDH_brainpoolP256r1_KMAC256,
        "X25519": id_MLKEM768_X25519_KMAC256,
    },
    "ml-kem-1024": {
        "ECDH-P384": id_MLKEM1024_ECDH_P384_KMAC256,
        "ECDH-brainpoolP384r1": id_MLKEM1024_ECDH_brainpoolP384r1_KMAC256,
        "X448": id_MLKEM1024_X448_KMAC256,
    },
}
