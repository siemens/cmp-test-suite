...
"""
    ...
    parser.add_argument("--ephemeral", help="Discard the detailed report generated by the test suite, " \
                        "the results printed on the screen are enough",
                        action="store_true", default=False)
    parser.add_argument("--verbose", help="Display additional debugging information",
                        action="store_true", default=False)

    parser.add_argument('robot_args', nargs=argparse.REMAINDER, help="Optional arguments to pass directly" \
                        "to Robot Framework.")
    ...
    if os.path.exists('/report'):
        ...
        if args.ephemeral or args.smoke:
            ...
            log.warning("The /report directory does not exist, the detailed test report will be lost after " \
